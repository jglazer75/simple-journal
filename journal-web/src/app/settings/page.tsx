    ...
    <div className="min-h-screen bg-[var(--background)] px-4 py-10 text-[var(--foreground)]">
      <main className="mx-auto flex w-full max-w-3xl flex-col gap-8 rounded-[32px] border border-[var(--border-soft)] bg-[var(--surface)] px-6 py-8 shadow-[var(--shadow-soft)] md:px-10 md:py-12">
        <header className="space-y-2">
          ...
          <h1 className="text-3xl font-semibold">Settings & maintenance</h1>
          <p className="text-base text-[var(--muted)]">
            Quick reference for connecting Ollama, seeding prompts, and keeping personas in sync until an admin dashboard lands.
          </p>
        </header>

        <section className="space-y-4 rounded-2xl border border-black/5 bg-white px-5 py-6">
          <h2 className="text-xl font-semibold">Environment essentials</h2>
        ...
        <section className="space-y-4 rounded-2xl border border-black/5 bg-white px-5 py-6">
          <h2 className="text-xl font-semibold">Seeding gratitude prompts</h2>
        ...
        <section className="space-y-4 rounded-2xl border border-black/5 bg-white px-5 py-6">
          <h2 className="text-xl font-semibold">Managing creative personas</h2>
          <p className="text-sm text-[var(--muted)]">
        ...
        <section className="space-y-4 rounded-2xl border border-black/5 bg-white px-5 py-6">
          <h2 className="text-xl font-semibold">Troubleshooting Ollama</h2>
          <ul className="list-disc space-y-2 pl-5 text-sm leading-relaxed text-[var(--foreground)]">
